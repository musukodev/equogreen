                ...
                <div x-data="{
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="flex items-center justify-between border-b border-gray-100 px-1 pb-2 text-xs">
                            <button type="button" @click="selectedVendors = vendors.map(v => v.id_vendor.toString())"
                        ...
                        <div class="flex max-h-48 flex-col gap-1 overflow-y-auto pr-1">
                            ...
                            <div x-show="filteredVendors.length === 0" class="py-4 text-center text-sm text-gray-500">
                                    ...
                                    <td class="border border-gray-400 p-0 text-center">
                                        @if (!$edit_id && count($items) > 1)
                                            <button type="button" wire:click="hapusBaris({{ $index }})"
                                                class="h-[45px] w-full text-gray-400 transition-colors duration-150 hover:text-red-600">
                                                <i class="fa-solid fa-trash"></i>
                                            </button>
                                        @else
                                            <span class="font-semibold text-gray-300">-</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
