<div class="relative" x-data="{ openNotifications: false }">
    ...
    <button @click="openNotifications = !openNotifications; if(openNotifications) { $wire.markAsRead() }"
        ...
        <img src="/gambar/bell-black.png" alt="Notifikasi" class="w-6 h-6 object-contain" />
        @if($unreadCount > 0)
    ...
    <div x-show="openNotifications" 
         ...
         class="absolute right-0 mt-2 w-96 bg-white border border-gray-200 rounded-2xl shadow-xl p-4 z-50 flex flex-col gap-3"
