    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto w-full">
        ...
        <header class="flex items-center justify-between p-4 md:p-6 lg:px-8 lg:pt-8 lg:pb-4">
            ...
            <div class="flex items-center gap-3">
                <!-- Notification Bell -->
                <button
                    class="w-12 h-12 flex items-center justify-center bg-[#f0f5ff] rounded-full border border-gray-200 hover:border-primary hover:bg-[#e4ebf5] transition-all duration-200 shadow-sm">
